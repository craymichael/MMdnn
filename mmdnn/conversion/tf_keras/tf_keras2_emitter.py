...
from mmdnn.conversion.tf_keras.extra_layers import Scale
from mmdnn.conversion.rewriter.folder import Folder


class TFKeras2Emitter(Emitter):
    ...
    def __init__(self, model):
        super(TFKeras2Emitter, self).__init__()
    ...
    def header_code(self):
        return """import tensorflow.keras as keras
...
def KitModel(weight_file = None):
    ...
    def gen_code(self, phase):
        ...
        for layer in self.IR_graph.topological_sort:
            ...
            if hasattr(self, "emit_" + node_type):
                ...
                print("TFKerasEmitter has not supported operator [%s]." % (node_type))
    ...
    def emit_Relu6(self, IR_node, in_scope=False):
        try:
            ...
            str_relu6 = 'tensorflow.keras.applications.mobilenet.relu6'
