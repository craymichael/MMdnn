...
from mmdnn.conversion.tf_keras.tf_keras2_graph import TFKeras2Graph
...
class TFKeras2Parser(Parser):
    ...
    def _load_model(self, model_network_path, model_weight_path):
        ...
        try:
            from tensorflow.keras.applications.mobilenet import relu6
    ...
    def __init__(self, model):
        super(TFKeras2Parser, self).__init__()
        ...
        self.keras_graph = TFKeras2Graph(model)
    ...
    def _copy_and_reop(source_node, IR_node, new_op = None):
        ...
        if hasattr(source_node.layer, "dtype"):
            IR_node.attr["dtype"].type = TFKeras2Parser.dtype_map[source_node.layer.dtype]

        TFKeras2Parser._set_output_shape(source_node, IR_node)
    ...
    def _defuse_activation(self, source_node):
        ...
        IR_node.op = TFKeras2Parser.activation_map[source_node.layer.activation.__name__]
    ...
    def _convert_convolution(self, source_node, dim):
        ...
        if source_node.type.startswith('Separable'):
            TFKeras2Parser._copy_and_reop(source_node, IR_node, "SeparableConv")
            ...
            if source_node.type.startswith('Conv'):
                if source_node.type.endswith('Transpose'):
                    TFKeras2Parser._copy_and_reop(source_node, IR_node, "ConvTranspose")
                else:
                    TFKeras2Parser._copy_and_reop(source_node, IR_node, "Conv")
            elif source_node.type.startswith('Deconv'):
                TFKeras2Parser._copy_and_reop(source_node, IR_node, "ConvTranspose")

            elif source_node.type.startswith('Depthwise'):
                TFKeras2Parser._copy_and_reop(source_node, IR_node, "DepthwiseConv")
        ...
        # pads
        TFKeras2Parser._convert_padding(source_node, IR_node)
    ...
    def _convert_pooling(self, source_node, dim, pooling_type, is_global):
        ...
        # name, op
        TFKeras2Parser._copy_and_reop(source_node, IR_node, "Pool")
        ...
        if is_global:
            ...
            TFKeras2Parser._set_output_shape(source_node, flatten_node)
    ...
    def _convert_merge(self, source_node, new_name = None):
        ...
        # name, op
        TFKeras2Parser._copy_and_reop(source_node, IR_node, new_name)
    ...
    def _convert_padding_api(self, source_node, IR_node, mode):
         # name, op
        TFKeras2Parser._copy_and_reop(source_node, IR_node, "Pad")
    ...
    def rename_UNKNOWN(self, source_node):
        ...
        # name, op
        TFKeras2Parser._copy_and_reop(source_node, IR_node)
    ...
    def rename_Activation(self, keras_node):
        ...
        # name, op
        try:
            TFKeras2Parser._copy_and_reop(keras_node, IR_node, self.activation_map[keras_node.keras_layer.activation.__name__])
        except:
            TFKeras2Parser._copy_and_reop(keras_node, IR_node, self.activation_map[keras_node.keras_layer.activation.name])
    ...
    def rename_InputLayer(self, source_node):
        ...
        # name, op
        TFKeras2Parser._copy_and_reop(source_node, IR_node, "DataInput")

        # input edge
        self.convert_inedge(source_node, IR_node)

        # shape
        TFKeras2Parser._copy_shape(source_node.keras_layer, IR_node)
    ...
    def rename_Dense(self, source_node):
        ...
        # name, op
        TFKeras2Parser._copy_and_reop(source_node, IR_node, "FullyConnected")
    ...
    def rename_LSTM(self, keras_node):
        ...
        # name, op
        TFKeras2Parser._copy_and_reop(keras_node, IR_node)
    ...
    def rename_Reshape(self, source_node):
        ...
        # name, op
        TFKeras2Parser._copy_and_reop(source_node, IR_node, 'Reshape')
    ...
    def rename_BatchNormalization(self, keras_node):
        ...
        # name, op
        TFKeras2Parser._copy_and_reop(keras_node, IR_node, 'BatchNorm')
    ...
    def _convert_crop(self, source_node):
        ...
        TFKeras2Parser._copy_and_reop(source_node, IR_node, "Crop")
    ...
    def rename_LeakyReLU(self, source_node):
        IR_node = self.IR_graph.node.add()
        TFKeras2Parser._copy_and_reop(source_node, IR_node, 'LeakyRelu')
        self.convert_inedge(source_node, IR_node)
    ...
    def rename_ReLU(self, source_node):
        ...
        if max_value == 6.0:
            TFKeras2Parser._copy_and_reop(source_node, IR_node, 'Relu6')
        else:
            TFKeras2Parser._copy_and_reop(source_node, IR_node, 'Relu')
    ...
    def rename_space_to_depth_x2(self, source_node):
        ...
        # name, op
        TFKeras2Parser._copy_and_reop(source_node, IR_node, 'SpaceToDepth')
